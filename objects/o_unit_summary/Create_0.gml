...
var window = instance_create_layer(xy[0], xy[1], L_DIALOG, o_gui_window)
window._w = 100
window._h = 100

var ndx = 0;

var nameElement = instance_create_layer(0,0, L_DIALOG, o_gui_text_element)
nameElement._rel_pos = RELATIVE_POSITION.TOP_LEFT
nameElement.depth = window.depth - 1

var hpElement = instance_create_layer(0,0,L_DIALOG, o_gui_text_element)
